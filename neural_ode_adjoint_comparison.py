# -*- coding: utf-8 -*-
"""Neural ODE Adjoint Implementation

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KwCszE__J86CifUU-lMtK4ex3xa9NyNE
"""
...
# ==========================================
# 1. The ODE Solver (Runge-Kutta 4)
# ==========================================
...
def odeint(func, y0, t_span, params, num_steps=100):
    ...
    # We use jax.lax.scan for efficiency (it compiles the loop)
...
# ==========================================
# 2. The Model (Dynamics Function f)
# ==========================================
...
# ==========================================
# 3. The Adjoint Method (Backward Pass)
# ==========================================
...
# ==========================================
# 4. Standard Autodiff (For Verification)
# ==========================================
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Check platform of default device
    ...
    # A. Compute with Standard JAX Autodiff (The Gold Standard)
